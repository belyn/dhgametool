-- Command line was: E:\github\dhgametool\scripts\ui\vip\minicard.lua 
...
ui.create = function()
  ...
  img.load(img.packedOthers.ui_vip_minicard)
  ...
  local bg = img.createUISprite(img.ui.vip_minicard_bg)
  ...
  local des = img.createUISprite(string.format("vip_minicard_des_%s.png", suffix))
