-- Command line was: E:\github\dhgametool\scripts\ui\activitylimit\summon.lua 
...
ui.create = function(l_1_0)
  ...
  if l_1_0 == cfglimitgift[IDS.SUMMON_4.ID].parameter then
    rewards = cfglimitgift[IDS.SUMMON_4.ID].rewards
    storeID = cfglimitgift[IDS.SUMMON_4.ID].storeId
    ids = IDS.SUMMON_4.ID
  else
    if l_1_0 == cfglimitgift[IDS.SUMMON_5.ID].parameter then
