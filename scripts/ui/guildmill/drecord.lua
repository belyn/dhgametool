-- Command line was: E:\github\dhgametool\scripts\ui\guildmill\drecord.lua 
...
ui.create = function()
  ...
  layer:addChild(bg)
  local titleLabel = lbl.createFont1(24, i18n.global.gmill_drecord_title.string, ccc3(255, 227, 134))
  ...
  bg:addChild(infobg)
  local namelab = lbl.createFontTTF(18, i18n.global.guild_create_guild_name.string, ccc3(235, 170, 94))
  namelab:setPosition(CCPoint(108, infobg:getContentSize().height / 2))
  infobg:addChild(namelab)
  local goldlab = lbl.createFontTTF(18, i18n.global.gmill_drecord_gold.string, ccc3(235, 170, 94))
  goldlab:setPosition(CCPoint(295, infobg:getContentSize().height / 2))
  infobg:addChild(goldlab)
  local timelab = lbl.createFontTTF(18, i18n.global.gmill_drecord_time.string, ccc3(235, 170, 94))
  timelab:setPosition(CCPoint(472, infobg:getContentSize().height / 2))
  infobg:addChild(timelab)
  local createScroll = function()
    local scroll_params = {width = 620, height = 310}
  ...
  local init = function()
    ...
    addWaitNet()
    net:donate_log(gParams, function(l_1_0)
      delWaitNet()
      tbl2string(l_1_0)
      if l_1_0.logs then
        local donatedata = l_1_0.logs
        showList(donatedata)
      else
