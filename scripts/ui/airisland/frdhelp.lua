-- Command line was: E:\github\dhgametool\scripts\ui\airisland\frdhelp.lua 
...
ui.create = function(l_1_0)
  ...
  local createItem = function(l_1_0)
    ...
    local lblInvite = lbl.createFont1(16, i18n.global.trial_stage_btn_battle.string, ccc3(115, 59, 5))
    ...
    applyAgreBtn:registerScriptTapHandler(function()
      ...
      addWaitNet()
      net:island_fight(param, function(l_1_0)
        delWaitNet()
        tbl2string(l_1_0)
        ...
        video.uid = param.uid
        video.camp = l_1_0.camp
        video.stage = content.stage
        airData.changeVit(-1)
        if not l_1_0.win or not video.atk then
          video.atk = {}
        end
        video.atk.camp = l_1_0.camp
        processPetPosAtk2(video)
