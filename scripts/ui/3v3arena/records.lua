-- Command line was: E:\github\dhgametool\scripts\ui\3v3arena\records.lua 
        ...
        for i,v in ipairs(logs) do
          ...
          if v.vid then
            ...
            local onVideo = function()
              local params = {sid = player.sid, id = 2, vid = v.vid}
              tbl2string(params)
              addWaitNet()
              net:video(params, function(l_1_0)
                ...
                layer:addChild(require("ui.3v3arena.videoDetail").create(l_1_0.video, i, orgData), 10000)
                     end)
                  end
