-- Command line was: E:\github\dhgametool\scripts\ui\activity\crushboss2.lua 
...
ui.create = function(l_1_0)
  ...
  btn_reward:registerScriptTapHandler(function()
    ...
    net:bboss_syn(gParams, function(l_1_0)
      ...
      layer:getParent():getParent():addChild(require("ui.activity.crushreward").create(2, l_1_0.id), 1000)
      end)
   end)
