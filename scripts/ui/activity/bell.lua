-- Command line was: E:\github\dhgametool\scripts\ui\activity\bell.lua 
...
local getVpState = function(l_1_0)
  ...
  if l_1_0.id == IDS.FISHBABY_1.ID then
    return STATE.GET
  else
...
ui.create = function()
  ...
  lbl_cd:setPosition(CCPoint(288, 30))
  ...
  lbl_cd_des:setPosition(CCPoint(370, 30))
