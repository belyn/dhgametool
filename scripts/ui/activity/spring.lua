-- Command line was: E:\github\dhgametool\scripts\ui\activity\spring.lua 
...
local vp_ids = {IDS.SPRINGBABY_1.ID, IDS.SPRINGBABY_2.ID, IDS.SPRINGBABY_3.ID, IDS.SPRINGBABY_4.ID, IDS.SPRINGBABY_5.ID, IDS.SPRINGBABY_6.ID, IDS.SPRINGBABY_7.ID, IDS.SPRINGBABY_8.ID}
ui.create = function()
