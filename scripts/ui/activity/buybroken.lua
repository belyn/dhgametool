-- Command line was: E:\github\dhgametool\scripts\ui\activity\buybroken.lua 
...
ui.create = function(l_1_0)
  ...
  local showTitle = lbl.createFont1(26, i18n.global.arena_buy_tickets.string, ccc3(230, 208, 174))
  showTitle:setPosition(board_bg:getContentSize().width / 2, board_bg_h - 30)
  board_bg:addChild(showTitle, 1)
  local showTitleShade = lbl.createFont1(26, i18n.global.arena_buy_tickets.string, ccc3(89, 48, 27))
  ...
  local icon_ticket = img.createItem(ITEM_ID_BROKEN)
  ...
  btn_buy:registerScriptTapHandler(function()
    ...
    netClient:bboss_buy(params, function(l_2_0)
