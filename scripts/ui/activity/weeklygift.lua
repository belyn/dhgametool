-- Command line was: E:\github\dhgametool\scripts\ui\activity\weeklygift.lua 
...
local vp_ids = {IDS.WEEKLY_GIFT.ID, IDS.WEEKLY_GIFT_2.ID, IDS.WEEKLY_GIFT_3.ID, IDS.WEEKLY_GIFT_4.ID}
ui.create = function()
  ...
  local banner = img.createUISprite(img.ui.activity_weekly_gift)
  ...
  local title = img.createUISprite(string.format("activity_weekly_gift_%s.png", suffix))
  title:setPosition(26, 11)
  title:setAnchorPoint(0, 0)
  banner:addChild(title)
  local lbl_cd_des = lbl.createFont2(14, i18n.global.activity_to_end.string)
  lbl_cd_des:setAnchorPoint(CCPoint(1, 0.5))
  lbl_cd_des:setPosition(CCPoint(515, 18))
  ...
  if i18n.getCurrentLanguage() == kLanguageRussian then
    lbl_cd_des:setPosition(CCPoint(475, 18))
