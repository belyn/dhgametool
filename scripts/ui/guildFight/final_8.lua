-- Command line was: E:\github\dhgametool\scripts\ui\guildFight\final_8.lua 
...
final_8.create = function(l_2_0)
  return final_8.new(l_2_0)
end

final_8.ctor = function(l_3_0, l_3_1)
  local BG_WIDTH = 786
  local BG_HEIGHT = 470
  ...
  local line0 = cc.p(0, 0).create(cc.p(23, 0), cc.p(23, -38)[1] == true)
   -- DECOMPILER ERROR: Overwrote pending register.

  bg:addChild(cc.p(46, -38))
   -- DECOMPILER ERROR: Overwrote pending register.

  droidhangComponents:mandateNode(line0, cc.p(46, -22))
   -- DECOMPILER ERROR: Overwrote pending register.
  ...
  local line1 = cc.p(0, 0).create(cc.p(23, cc.p(69, -22)), cc.p(23, 38)[1] ~= true)
   -- DECOMPILER ERROR: Overwrote pending register.

  bg:addChild(cc.p(46, 38))
   -- DECOMPILER ERROR: Overwrote pending register.

  droidhangComponents:mandateNode(line1, cc.p(46, 54))
   -- DECOMPILER ERROR: Overwrote pending register.
  ...
  local line2 = cc.p(0, 0).create(cc.p(23, cc.p(69, 54)), cc.p(23, -38)[2] == true)
   -- DECOMPILER ERROR: Overwrote pending register.

  bg:addChild(cc.p(46, -38))
   -- DECOMPILER ERROR: Overwrote pending register.

  droidhangComponents:mandateNode(line2, cc.p(46, 22))
   -- DECOMPILER ERROR: Overwrote pending register.
  ...
  local line3 = cc.p(0, 0).create(cc.p(23, cc.p(69, 22)), cc.p(23, 38)[2] ~= true)
   -- DECOMPILER ERROR: Overwrote pending register.

  bg:addChild(cc.p(46, 38))
   -- DECOMPILER ERROR: Overwrote pending register.

  droidhangComponents:mandateNode(line3, cc.p(46, 98))
   -- DECOMPILER ERROR: Overwrote pending register.
  ...
  local line4 = cc.p(0, 0).create(cc.p(-23, cc.p(69, 98)), cc.p(-23, -38)[3] == true)
   -- DECOMPILER ERROR: Overwrote pending register.

  bg:addChild(cc.p(-46, -38))
   -- DECOMPILER ERROR: Overwrote pending register.

  droidhangComponents:mandateNode(line4, cc.p(-46, -98))
   -- DECOMPILER ERROR: Overwrote pending register.
  ...
  local line5 = cc.p(0, 0).create(cc.p(-23, cc.p(-69, -98)), cc.p(-23, 38)[3] ~= true)
   -- DECOMPILER ERROR: Overwrote pending register.

  bg:addChild(cc.p(-46, 38))
   -- DECOMPILER ERROR: Overwrote pending register.

  droidhangComponents:mandateNode(line5, cc.p(-46, -22))
   -- DECOMPILER ERROR: Overwrote pending register.
  ...
  local line6 = cc.p(0, 0).create(cc.p(-23, cc.p(-69, -22)), cc.p(-23, -38)[4] == true)
   -- DECOMPILER ERROR: Overwrote pending register.

  bg:addChild(cc.p(-46, -38))
   -- DECOMPILER ERROR: Overwrote pending register.

  droidhangComponents:mandateNode(line6, cc.p(-46, -58))
   -- DECOMPILER ERROR: Overwrote pending register.
  ...
  do
    local line7 = cc.p(0, 0).create(cc.p(-23, cc.p(-69, -58)), cc.p(-23, 38)[4] ~= true)
     -- DECOMPILER ERROR: Overwrote pending register.

    bg:addChild(cc.p(-46, 38))
     -- DECOMPILER ERROR: Overwrote pending register.

    droidhangComponents:mandateNode(line7, cc.p(-46, 18))
  end
