-- Command line was: E:\github\dhgametool\scripts\ui\frdarena\rank.lua 
...
local createItem = function(l_1_0, l_1_1)
  ...
  local lbl_name = lbl.createFontTTF(16, l_1_0.name, ccc3(81, 39, 18))
...
ui.create = function()
  ...
  local init = function()
    ...
    addWaitNet()
    net:gpvp_ranklist(gParams, function(l_1_0)
      delWaitNet()
      tbl2string(l_1_0)
      if l_1_0.team then
        showList(l_1_0.team)
