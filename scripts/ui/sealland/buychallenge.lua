-- Command line was: E:\github\dhgametool\scripts\ui\sealland\buychallenge.lua 
...
ui.create = function(l_2_0, l_2_1)
  ...
  okBtn:registerScriptTapHandler(function()
    ...
    ui.buy(ticket_count, function(l_1_0)
      ...
      sealLandData:buyChallenge(ticket_count)
      if callback then
        callback()
      end
...
ui.buy = function(l_3_0, l_3_1)
  ...
  tbl2string(nParams)
  net:sealland_challenge_buy(nParams, function(l_1_0)
    callback(l_1_0)
   end)
end
