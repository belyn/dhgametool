-- Command line was: E:\github\dhgametool\scripts\ui\friends\scorerank.lua 
...
local createSelfItem = function(l_2_0, l_2_1)
  ...
  local flag = img.createPlayerHead(l_2_0.logo)
  flag:setScale(0.7)
  ...
  item:addChild(lvbottom)
  local lvlab = lbl.createFont1(14, string.format("%d", l_2_0.lv), ccc3(255, 246, 223))
  lvlab:setPosition(CCPoint(lvbottom:getContentSize().width / 2, lvbottom:getContentSize().height / 2))
  lvbottom:addChild(lvlab)
  local lbl_lv_des = lbl.createFont1(14, i18n.global.arena_main_score.string, ccc3(138, 96, 76))
...
ui.create = function()
  ...
  local lbl_title = lbl.createFont1(24, i18n.global.friendboss_integral_rank.string, ccc3(230, 208, 174))
  lbl_title:setPosition(CCPoint(board_bg_w / 2, board_bg_h - 29))
  board_bg:addChild(lbl_title, 2)
  local lbl_title_shadowD = lbl.createFont1(24, i18n.global.friendboss_integral_rank.string, ccc3(89, 48, 27))
