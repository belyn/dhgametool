-- Command line was: E:\github\dhgametool\scripts\fight\solo\video.lua 
...
ui.create = function(l_1_0)
  ...
  layer.getVideoAndUnits = function()
    ...
    for i,h in pairs(video.atk.camp) do
      attackers[i] = hHelper.createHero({id = h.id, lv = h.lv, pos = h.pos or 1, star = h.star, side = "attacker", ep = h.mp, hp = h.hp, wake = h.wake, skin = h.skin})
    end
    local defenders = {}
