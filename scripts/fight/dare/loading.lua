-- Command line was: E:\github\dhgametool\scripts\fight\dare\loading.lua 
...
ui.backToUI = function(l_2_0)
  ...
  if memflag == true then
    ...
    replaceScene(require("ui.town.main").create({from_layer = "dareStage", type = l_2_0.type}))
  end
end
...
ui.backToSummon = function(l_6_0)
...
ui.getMapAndHeroIds = function(l_7_0)
  local mapId, heroIds, pets = cfgdarestage[l_7_0.stage].map, {}, {}
  local skins = {}
...
ui.getMapAndHeroIds2 = function(l_8_0)
  ...
  local mapId, heroIds, pets = cfgdarestage[l_8_0.stage].map, {}, {}
  local skins = {}
  local heroList = {}
