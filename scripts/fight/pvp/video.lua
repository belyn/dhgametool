-- Command line was: E:\github\dhgametool\scripts\fight\pvp\video.lua 
...
ui.create = function(l_1_0)
  ...
  layer.getVideoAndUnits = function()
    ...
    for i,h in pairs(video.atk.camp) do
      attackers[i] = hHelper.createHero({hid = h.hid, pos = h.pos, side = "attacker", ep = h.energy, wake = h.wake, skin = h.skin})
    end
    local defenders = {}
