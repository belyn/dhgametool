-- Command line was: E:\github\dhgametool\scripts\fight\gboss\loading.lua 
...
ui.getMapAndHeroIds = function(l_3_0)
  local mapId, heroIds, pets = cfggboss[l_3_0.boss].map, {}, {}
  local skins = {}
  ...
  for _,m in ipairs(cfggboss[l_3_0.boss].monster) do
...
ui.getMapAndHeroIds2 = function(l_4_0)
  ...
  local mapId, heroIds, pets = cfggboss[l_4_0.boss].map, {}, {}
  local skins = {}
  local heroList = {}
  ...
  for _,m in ipairs(cfggboss[l_4_0.boss].monster) do
    heroIds[ heroIds + 1] = cfgmons[m].heroLink
