-- Command line was: E:\github\dhgametool\scripts\common\opposdkcfg.lua 
...
cfg.login = function(l_2_0, l_2_1)
  ...
  SDKHelper:getInstance():login(txparamsstr, function(l_1_0)
    ...
    if __data and __data.errcode and __data.errcode ~= 0 then
      ...
      local jparams = {token = __data.token, ssoid = __data.ssoid}
      local jsonstr = jsonEncode(jparams)
      local nparams = {sid = 0, jsonStr = jsonstr, platform = "oppo"}
...
cfg.pay = function(l_5_0, l_5_1)
  local oparams = {productId = l_5_0.productId, type = 6}
  addWaitNet()
  getOrder(oparams, function(l_1_0)
    tablePrint(l_1_0)
    local netOrder = jsonDecode(l_1_0.order_info)
    local txParams = {order = netOrder.partnerOrder, amount = netOrder.price, attach = netOrder.attach, callbackUrl = netOrder.notifyUrl, productName = "\230\184\184\230\136\143\231\164\188\229\140\133", productDesc = "\230\184\184\230\136\143\231\164\188\229\140\133"}
    ...
    SDKHelper:getInstance():pay(paramStr, function(l_1_0)
      ...
      local gParams = {sid = player.sid, orderid = netOrder.partnerOrder or "", appsflyer = HHUtils:getAppsFlyerId(), advertising = HHUtils:getAdvertisingId()}
