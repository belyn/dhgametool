-- Command line was: E:\github\dhgametool\scripts\common\games63sdkcfg.lua 
...
cfg.pay = function(l_4_0, l_4_1)
  local oparams = {productId = l_4_0.productId, type = 29}
  addWaitNet()
  getOrder(oparams, function(l_1_0)
    tablePrint(l_1_0)
    local netOrder = jsonDecode(l_1_0.order_info)
    local ucParams = {order_id = netOrder.cpOrderId, price = netOrder.price}
    ...
    SDKHelper:getInstance():pay(netOrder.paydata, function(l_1_0)
...
cfg.submitRoleData = function(l_5_0, l_5_1)
  if not l_5_0 or l_5_0.stype ~= "enterServer" then
    return 
  end
  local sparams = {role_id = l_5_0.roleId .. "", role_name = l_5_0.roleName .. "", role_lv = checkint(l_5_0.roleLevel), server_id = l_5_0.zoneId .. "", server_name = l_5_0.zoneName .. "", balance = require("data.bag").gem() .. "", vip_lv = player.vipLv() .. ""}
  cfg.need_submit = nil
